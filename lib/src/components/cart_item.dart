...
class CartItem extends GetView<ProductController> {
  ...
  Widget build(BuildContext context) {
    ...
    double extrasPrice =
        product!.extras!.fold(0, (prev, current) => prev + current.price!);
              ...
              Container(
                  ...
                  child: Wrap(
                    ...
                    children: <Widget>[
                      Text(
                          extrasPrice > 0
                              ? "( ${controller.getDiscountPrice(product!.discount!, product!.price!, product!.discountType!)} + $extrasPrice ) $symbol"

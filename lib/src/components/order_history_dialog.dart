...
import 'package:promarket/src/components/chart.dart';
import 'package:promarket/src/components/order_history_dialog_date_item.dart';
import 'package:promarket/src/components/order_history_dialog_dot.dart';
import 'package:promarket/src/components/order_history_dialog_step.dart';
import 'package:promarket/src/components/order_history_dialog_step_info.dart';
import 'package:promarket/src/components/order_history_product_item.dart';
...
import 'package:promarket/src/requests/order_cancel_request.dart';
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "${double.parse((data['total_sum'] + data['total_discount'] - data['delivery_fee'] - data['tax']).toString()).toStringAsFixed(2)} $currency",
                            style: TextStyle(
                                fontFamily: 'Inter',
                                fontWeight: FontWeight.w700,
                                fontSize: 16.sp,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "- ${double.parse(data['total_discount'].toString()).toStringAsFixed(2)} $currency",
                            style: TextStyle(
                                fontFamily: 'Inter',
                                fontWeight: FontWeight.w700,
                                fontSize: 16.sp,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "${double.parse(data['total_sum'].toString()).toStringAsFixed(2)} $currency",
                            style: TextStyle(
                                fontFamily: 'Inter',
                                fontWeight: FontWeight.w700,
                                fontSize: 24.sp,

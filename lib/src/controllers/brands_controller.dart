...
import 'package:promarket/src/models/brand.dart';
import 'package:promarket/src/models/brand_category.dart';
import 'package:promarket/src/models/product.dart';
import 'package:promarket/src/models/shop.dart';
import 'package:promarket/src/requests/brand_categories_request.dart';
import 'package:promarket/src/requests/brands_products_request.dart';
import 'package:promarket/src/requests/brands_request.dart';
    ...
    if (load.value) {
      ...
      if (data['success']) {
        for (int i = 0; i < data['data'].length; i++) {
          ...
          double tax = double.parse((item['category']['taxes'].length > 0
                  ? item['category']['taxes']
          ...
          if (index == -1)
            brandpList.add(Product(
                ...
                price: double.parse(item['origin_price'].toString()),

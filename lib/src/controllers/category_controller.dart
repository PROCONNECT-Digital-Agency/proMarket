...
import 'package:promarket/src/requests/category_product_request.dart';
import 'package:promarket/src/requests/category_request.dart';
          ...
          if (index == -1)
            productList.add(Product(
                ...
                rating: int.parse(item['comments_count'].toString()) > 0
                    ...
                    : 5.0,
                price: item['origin_price'] != null ? double.parse(item['origin_price'].toString()) : 0,

...
import 'package:promarket/src/models/currency.dart';
import 'package:promarket/src/models/shop.dart';
import 'package:promarket/src/requests/currency_request.dart';
...
class CurrencyController extends GetxController {
  ...
  String getActiveCurrencySymbol() {
    if (activeCurrencyId.value > 0) {
      int index = currencyList
          .indexWhere((element) => element.id == activeCurrencyId.value);

      if (index > -1) return "${currencyList[index].symbol}";
    }

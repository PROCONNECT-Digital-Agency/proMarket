...
import 'package:promarket/src/models/shop.dart';
import 'package:promarket/src/models/time_unit.dart';
import 'package:promarket/src/models/user.dart';
import 'package:promarket/src/requests/shop_categories_request.dart';
import 'package:promarket/src/requests/shop_timeunits.dart';
import 'package:promarket/src/requests/shops_request.dart';
import 'package:promarket/src/utils/utils.dart';
...
class ShopController extends GetxController with SingleGetTickerProviderMixin {
      ...
      if (data['success']) {
        ...
        for (int i = 0; i < savedShopList.length; i++) {
          ...
          if (index == -1) {
            ...
            String taxes = data['data'][index]['taxes']
  ...
  void addToSavedShop(Map<String, dynamic> shopData) {
    ...
    String taxes =
        shopData['taxes'].fold(0, (a, b) => a + b['percent']).toString();
    ...
    cartController.getShippingDetail();

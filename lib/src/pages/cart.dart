...
import 'package:promarket/src/components/cart_item.dart';
import 'package:promarket/src/components/cart_summary.dart';
import 'package:promarket/src/components/coupon.dart';
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      controller.orderController.load.value = true;
                      controller.orderController.getOrderCount(user.id!);
                      Get.toNamed("/orderHistory");
                    },
                    style: ButtonStyle(
                        padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                            EdgeInsets.all(0))),
                    child: Text("Open Order history",
                        style: TextStyle(
                          fontFamily: 'Inter',
                          fontWeight: FontWeight.w500,
                          fontSize: 16.sp,
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            "${controller.calculateAmount().toStringAsFixed(2)} $symbol",
                            style: TextStyle(
                                fontFamily: 'Inter',

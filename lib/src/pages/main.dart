...
import 'package:promarket/src/components/home_tab_button.dart';
...
import 'package:promarket/src/pages/categories.dart';
import 'package:promarket/src/pages/home.dart';
import 'package:promarket/src/pages/savings.dart';
                  ...
                  children: <Widget>[
                    ...
                    if (user!.id != null && user!.id! > 0)
                      ...
                      SizedBox(
                        ...
                        child: HomeTabButton(
                          title: "Sign In".tr,
                          icon: const IconData(0xeed4, fontFamily: 'MIcon'),
                          isActive: false,
                          onTap: () {

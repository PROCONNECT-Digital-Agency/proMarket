...
import 'package:promarket/src/components/comment_dialog.dart';
import 'package:promarket/src/components/comment_item.dart';
import 'package:promarket/src/components/extras_button.dart';
import 'package:promarket/src/components/extras_color.dart';
import 'package:promarket/src/components/extras_image.dart';
import 'package:promarket/src/components/extras_with_select.dart';
import 'package:promarket/src/components/home_category_products.dart';
import 'package:promarket/src/components/image_viewer.dart';
...
class ProductDetail extends GetView<ProductController> {
  ...
  Widget build(BuildContext context) {
    String symbol = controller.currencyController.getActiveCurrencySymbol();
    String unit = controller.activeProduct.value.unit ?? "";
    ...
    return Obx(() {
      ...
      User? user =
          controller.cartController.shopController.authController.user.value;
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: <Widget>[
                            Text(
                                "${controller.getDiscountPrice(product.discount!, product.price!, product.discountType!)} $symbol",
                                style: TextStyle(
                                    fontFamily: 'Inter',
                                ...
                                children: <Widget>[
                                  RichText(
                                      text: TextSpan(
                                        ...
                                        TextSpan(
                                            text:
                                                " ${controller.getDiscount(product.discount!, product.discountType!)} — ${controller.getDiscountAmount(product.discount!, product.price!, product.discountType!)} $symbol",
                                            style: TextStyle(
                                                fontFamily: 'Inter',
                                                fontWeight: FontWeight.w700,
                                                fontSize: 12.sp,
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Obx(
                        () => Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "${controller.cartController.calculateAmount()} $symbol",
                              style: TextStyle(
                                  fontFamily: 'Inter',
                                  fontWeight: FontWeight.w700,
                                  fontSize: 28.sp,
                      ...
                      InkWell(
                        ...
                        onTap: () {
                          controller.cartController.checkCard();
                          Get.toNamed("/cart");
                        },
                      ),

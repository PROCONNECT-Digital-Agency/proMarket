...
import 'package:promarket/src/components/settings_item.dart';
import 'package:promarket/src/components/sp_checkbox.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            InkWell(
              ...
              onTap: () => Share.share(
                  '${"check out our website".tr} https://admin.promarket.com'),
            )
          ],
        ),
      ),
